...
//
// Post Phase 4 of plans/spec-first-pivot.md: SCENARIO-PATCH rules have been
// eliminated. Every nontrivial transformation must carry:
//   `// NORMALIZATION(<spec-ref>):` — derivable from the openCypher 9 / GQL spec.
